...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\truly\\Desktop\\Neuer Ordner\\ma_study_1\\study_1.py',
...
instruction_text_2 = visual.TextStim(win=win, name='instruction_text_2',
    text="During the task, you'll be selecting from various options, each providing a different number of game points. These points will be tallied at the end and converted into a bonus payment. You could earn up to an additional £3 based on your performance, which is separate from the guaranteed £2.25 completion reward.\n\nPress 'space' to continue",
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
for thisTrial in trials:
    ...
    thisExp.addData('choice', choices.keys)
    # check responses
    ...
    thisExp.addData('reward', obtained_reward)
