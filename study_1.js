...
function fake_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fake_instructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fake_instructions_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fake_instructions_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fake_instructions_3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fake_instructions_3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fake_instructions_4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fake_instructions_4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fake_instructions_5RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fake_instructions_5Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fake_instructions_6RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fake_instructions_6Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fake_instructions_7RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fake_instructions_7Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fake_instructions_8RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fake_instructions_8Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fake_instructions_9RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fake_instructions_9Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fake_instructions_10RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fake_instructions_10Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fake_instructions_11RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fake_instructions_11Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fake_instructions_12RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fake_instructions_12Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fake_instructions_13RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fake_instructions_13Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fake_instructions_14RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fake_instructions_14Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function real_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of real_instructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function real_instructions_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of real_instructions_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function real_instructions_2_5RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of real_instructions_2_5Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function real_instructions_3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of real_instructions_3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function training_reward_displayRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of training_reward_displayComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function att_check_primerRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of att_check_primerComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function att_check_1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of att_check_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function att_1_feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of att_1_feedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function exp_start_primerRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of exp_start_primerComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function reward_displayRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of reward_displayComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
